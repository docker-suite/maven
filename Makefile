...
build: ## Build all versions
	@$(MAKE) build-version v=3.5-jdk-7
	@$(MAKE) build-version v=3.5-jdk-8
	@$(MAKE) build-version v=3.6-jdk-7
	@$(MAKE) build-version v=3.6-jdk-8

test: ## Test all versions
	@$(MAKE) test-version v=3.5-jdk-7
	@$(MAKE) test-version v=3.5-jdk-8
	@$(MAKE) test-version v=3.6-jdk-7
	@$(MAKE) test-version v=3.6-jdk-8

push: ## Push all versions
	@$(MAKE) push-version v=3.5-jdk-7
	@$(MAKE) push-version v=3.5-jdk-8
